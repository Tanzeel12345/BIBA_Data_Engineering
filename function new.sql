...
create table orders (Customer_id INT,order_id INT, order_status VARCHAR(255),order_delivered VARCHAR(255),carrier_date Varchar(255));

Insert into orders values (1,'102', 'pending', 'Yes', '12-11-2023'),
                          (2,'103', 'delivered','No', '11-11-2023'),
						  (3,'104', 'pending', 'Yes', '10-11-2023');
